...
public interface ApiStores {
    ...
    //Call<Now> getNow(@Query("key") String key, @Query("ic_location") String ic_location, @Query("language") String language, @Query("unit") String unit);

    //@GET("weather/now.json")
    //Observable<Now> getNow1(@Query("key") String key, @Query("ic_location") String ic_location, @Query("language") String language, @Query("unit") String unit);
     ...
     *
     * @return weather/grid/now.json?key=52zpuzgswyulc0w6&ic_location=39.865927:116.359805
     */
    @GET("weather/grid/now.json")
    Call<NowGrid> getGridNow(@Query("key") String key, @Query("ic_location") String location);

    /**
     * 分钟级降水预报（付费接口）
     * 获取指定经纬度的分钟级降水预报。数据精度是1x1公里，区域范围覆盖中国。
     *
     * @return weather/grid/minutely.json?key=52zpuzgswyulc0w6&ic_location=39.865927:116.359805
     */
    @GET("weather/grid/minutely.json")
    Call<Minutely> getMinutely(@Query("key") String key, @Query("ic_location") String location);
     ...
     *
     * @return weather/hourly.json?key=52zpuzgswyulc0w6&ic_location=beijing&language=zh-Hans&unit=c&start=0&hours=24
     */
    @GET("weather/hourly.json")
    Call<Hourly> getHourly(@Query("key") String key, @Query("ic_location") String location, @Query("language") String language, @Query("unit") String unit, @Query("start") String start, @Query("hours") String hours);

    /**
     * 过去24小时历史天气（付费接口）
     * 获取指定城市过去24小时逐小时的历史天气。
     *
     * @return weather/hourly_history.json?key=52zpuzgswyulc0w6&ic_location=seattle&language=zh-Hans&unit=c
     */
    @GET("weather/hourly_history.json")
    Call<HourlyHistory> getHourlyHistory(@Query("key") String key, @Query("ic_location") String location, @Query("language") String language, @Query("unit") String unit);

    /**
     * 15天逐3小时精细化天气预报（付费接口）
     * 获取指定城市未来15天的精细化天气预报。未来3天逐3小时；未来4-6天逐6小时；未来7-15天逐12小时
     *
     * @return weather/hourly3h.json?key=52zpuzgswyulc0w6&ic_location=beijing
     */
    @GET("weather/hourly3h.json")
    Call<Hourly3h> getHourly3h(@Query("key") String key, @Query("ic_location") String location);

    /**
     * 气象灾害预警（付费接口）
     * 获取当前所有城市或指定城市的气象灾害预警信息。当前城市无预警信息时返回值为空，请做好空值处理。
     *
     * @return weather/alarm.json?key=52zpuzgswyulc0w6&ic_location=beijing
     */
    @GET("weather/alarm.json")
    Call<Alarm> getAlarm(@Query("key") String key, @Query("ic_location") String location);
     ...
     *
     * @return 北京市的空气质量 air/now.json?key=52zpuzgswyulc0w6&ic_location=beijing&language=zh-Hans&scope=city
     * 北京市及下属监测站的空气质量 air/now.json?key=52zpuzgswyulc0w6&ic_location=beijing&language=zh-Hans&scope=all
     */
    @GET("air/now.json")
    Call<AirNow> getAirNow(@Query("key") String key, @Query("ic_location") String location, @Query("language") String language, @Query("scope") String scope);
     ...
     *
     * @return air/daily.json?key=52zpuzgswyulc0w6&language=zh-Hans&ic_location=Beijing
     */
    @GET("air/daily.json")
    Call<AirDaily> getAirDaily(@Query("key") String key, @Query("language") String language, @Query("ic_location") String location);

    /**
     * 逐小时空气质量预报（付费接口）
     * 获取指定城市未来最多7天的逐小时AQI预报。
     *
     * @return air/hourly.json?key=52zpuzgswyulc0w6&language=zh-Hans&ic_location=Beijing
     */
    @GET("air/hourly.json")
    Call<AirHourly> getAirHourly(@Query("key") String key, @Query("language") String language, @Query("ic_location") String location);

    /**
     * 过去24小时历史空气质量（付费接口）
     * 获取指定城市过去24小时逐小时的AQI、PM2.5、PM10、一氧化碳、二氧化氮、臭氧等空气质量信息。
     *
     * @return 北京市过去24小时的逐小时空气质量 air/hourly_history.json?key=52zpuzgswyulc0w6&ic_location=beijing&language=zh-Hans&scope=city
     * 北京市及下属监测站过去24小时的逐小时空气质量 air/hourly_history.json?key=52zpuzgswyulc0w6&ic_location=beijing&language=zh-Hans&scope=all
     */
    @GET("air/hourly_history.json")
    Call<HourlyHistory> get(@Query("key") String key, @Query("language") String language, @Query("ic_location") String location, @Query("scope") String scope);
    ...
    //Observable<Suggestion> getLifeSuggestion(@Query("key") String key, @Query("ic_location") String ic_location, @Query("language") String language);
     ...
     *
     * @return 北京https://api.seniverse.com/v3/life/driving_restriction.json?key=52zpuzgswyulc0w6&ic_location=WX4FBXXFKE4F
     * 天津https://api.seniverse.com/v3/life/driving_restriction.json?key=52zpuzgswyulc0w6&ic_location=WWGQDCW6TBW1
     * 哈尔滨https://api.seniverse.com/v3/life/driving_restriction.json?key=52zpuzgswyulc0w6&ic_location=YB1UX38K6DY1
     * 成都https://api.seniverse.com/v3/life/driving_restriction.json?key=52zpuzgswyulc0w6&ic_location=WM6N2PM3WY2K
     * 杭州https://api.seniverse.com/v3/life/driving_restriction.json?key=52zpuzgswyulc0w6&ic_location=WTMKQ069CCJ7
     * 贵阳https://api.seniverse.com/v3/life/driving_restriction.json?key=52zpuzgswyulc0w6&ic_location=WKEZD7MXE04F
     * 长春https://api.seniverse.com/v3/life/driving_restriction.json?key=52zpuzgswyulc0w6&ic_location=WZC1EXZ0P9HU
     * 兰州https://api.seniverse.com/v3/life/driving_restriction.json?key=52zpuzgswyulc0w6&ic_location=WZC1EXZ0P9HU
     */
    @GET("life/driving_restriction.json")
    Call<DrivingRestriction> getLifeDrivingRestriction(@Query("key") String key, @Query("ic_location") String location);

    /**
     * 逐小时潮汐（付费接口）
     * 获取指定港口或者某个城市下的全部港口未来最多18天的潮汐数据，包括每天24小时的逐小时潮汐高度，以及每天的高低潮时间及高度。
     *
     * @return https://api.seniverse.com/v3/tide/daily.json?key=52zpuzgswyulc0w6&ic_location=dandong
     */
    @GET("tide/daily.json")
    Call<TideDaily> getTideDaily(@Query("key") String key, @Query("ic_location") String location);

    /**
     * 日出日落（付费接口）
     * 查询全球各地最多15天的日出日落时间。
     *
     * @return 北京从今天开始7天的日出日落时间 geo/sun.json?key=52zpuzgswyulc0w6&ic_location=beijing&language=zh-Hans&start=0&days=7
     * 北京从指定日期开始7天的日出日落时间 geo/sun.json?key=52zpuzgswyulc0w6&ic_location=beijing&language=zh-Hans&start=2016/10/1&days=7
     */
    @GET("geo/sun.json")
    Call<Sun> getSun(@Query("key") String key, @Query("ic_location") String location, @Query("language") String language, @Query("start") String start, @Query("days") String days);

    /**
     * 月出月落和月相（付费接口）
     * 查询全球各地最多15天的月出月落时间和月相。
     *
     * @return 北京从今天开始7天的月出月落时间和月相 geo/moon.json?key=52zpuzgswyulc0w6&ic_location=beijing&language=zh-Hans&start=0&days=7
     * 北京从指定日期开始7天的月出月落时间和月相 geo/moon.json?key=52zpuzgswyulc0w6&ic_location=beijing&language=zh-Hans&start=2015/9/20&days=7
     */
    @GET("geo/moon.json")
    Call<Moon> getMoon(@Query("key") String key, @Query("ic_location") String location, @Query("language") String language, @Query("start") String start, @Query("days") String days);
