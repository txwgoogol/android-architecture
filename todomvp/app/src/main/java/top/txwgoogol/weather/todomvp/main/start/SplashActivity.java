package top.txwgoogol.weather.todomvp.main.start;
...
import top.txwgoogol.weather.todomvp.main.MainActivity;
import top.txwgoogol.weather.todomvp.service.AutoUpdateService;
import top.txwgoogol.weather.todomvp.util.AmapUtils;
...
public class SplashActivity extends AppCompatActivity {
     ...
     */
    private void forward(boolean canJump) {
        if (canJump) {
